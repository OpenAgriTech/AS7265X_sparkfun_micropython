...
class AS7265X:
    ...
    #Get all values
    def get_all_values(self, calibrated=True, debug=False):
        value = []
    ...
    def get_wavelengths(self):
        if self._mode == AS7265X_MEASUREMENT_MODE_4CHAN:
            return [435,485,535,585,645,705,760,860,940]
        elif self._mode == AS7265X_MEASUREMENT_MODE_4CHAN_2:
            return [410,460,510,560,610,680,730,810,900]
        elif self._mode == AS7265X_MEASUREMENT_MODE_6CHAN_CONTINUOUS or self._mode == AS7265X_MEASUREMENT_MODE_6CHAN_ONE_SHOT:
            return [410,435,460,485,510,535,560,585,610,645,680,705,730,760,810,860,900,940]
